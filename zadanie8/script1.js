...
window.onload = () => {
    ...
    add.addEventListener('click', (e) => {
        ...
        //console.log(jsonobject);
        w3.postMessage(JSON.stringify(jsonobject));
        ...
        w3.onmessage = function(e) {
            ...
            img.setAttribute("src", document.getElementById('photo').value);
            img.addEventListener("load", function () {
                ...
                savedPhoto = canvas.toDataURL('image/jpeg', 0.5);
                //document.getElementById('readyPhoto2').src = savedPhoto;
                ...
                var data_number = document.getElementById('number').value;
                var data_zip = document.getElementById('zip').value;
                var data_photoURL = document.getElementById('photo').value;
                ...
                var request = objectStore.add({
                    ...
                    number: data_number,
                    zip: data_zip,
                    photoURL: data_photoURL,
                    photoSaved: savedPhoto
                });
                canvas.getContext("2d").clearRect(0, 0, 100, 100);
                update();
...
function generateButton()
{
    ...
    var data_photoURL = "https://upload.wikimedia.org/wikipedia/commons/thumb/7/71/Calico_tabby_cat_-_Savannah.jpg/220px-Calico_tabby_cat_-_Savannah.jpg";
    var savedPhoto = "data:image/jpeg;base64,";
...
function editButton(user_ID) {
    ...
    document.getElementById('photo').value = data.result.photoURL;
    document.getElementById('readyPhoto2').src = data.result.photoSaved;
    }
